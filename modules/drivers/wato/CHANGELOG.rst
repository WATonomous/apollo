...
* Removed wato_ prefix from methods
* Moved methods to parse pixel_format and io_method from string to UsbCam
* Moved wato_image_t struct to be private in UsbCam
...
0.2.0 (2015-01-16)
------------------
* Bug fix in wato info settings.
* Update .travis.yml
* Merge pull request #27 from bosch-ros-pkg/default_wato_info
  sets default wato info
* sets default wato info
...
------------------
* changelog fixed
* minor cleanup and ability to change wato name and info
* Contributors: Russell Toris

0.1.6 (2014-08-15)
------------------
* Merge pull request #14 from KaijenHsiao/master
  added support for 10-bit mono watos advertising as YUV
* added support for 10-bit mono watos advertising as YUV (such as Leopard Imaging's LI-USB30-V034)
...
* Updated the usb_cam config to work for home wato.
